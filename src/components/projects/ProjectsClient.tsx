...
import { LayoutGrid, Plus, ArrowRight, FolderOpen, Calendar } from "lucide-react"
...
export default function ProjectsClient({ initialBoards, isAdmin }: Props) {
            ...
            <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-black text-slate-900 tracking-tight">Ваші Проєкти</h1>
