...
export default function DashboardClient({ tracks, tasks, statusMap, isAdmin, userName, userImage, firstName, hasContacts, projects, role }: Props) {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#020617] overflow-x-hidden font-sans relative">
            ...
            <div className="flex px-4 py-0 gap-4 relative z-10 w-full max-w-[1600px] mx-auto">
                <div className="flex-shrink-0 w-80 rounded-[2rem] overflow-hidden glass-card-premium border border-white/5 shadow-2xl sticky top-16 self-start h-[calc(100vh-4rem)]">
                    <Sidebar
                        tracks={tracks}
